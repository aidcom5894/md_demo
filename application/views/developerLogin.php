...
<dd><input type="text" tabindex="1" name="portalusername" id="username" size="25" value="" class="inputbox autowidth" /></dd>
</dl>
<dl>
<dt><label for="password">Password:</label></dt>
<dd><input type="password" tabindex="2" id="password" name="portalpassword" size="25" class="inputbox autowidth" autocomplete="off" /></dd>
</dl>
<dl>
...
<input type="submit" tabindex="5" name="login" value="Login" class="button1" />	</dd>
</dl>
</fieldset>
</div>
